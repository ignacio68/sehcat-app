...
export default function TechnicalSheets() {
  ...
  const { color, title } = screenConfig.technicalSheets;
      ...
      <View className={`flex-1 ${getLayoutStyle()} mb-4`}>
        ...
        >
          <ScrollView className="p-4">
            {/* Aquí irá el contenido de las fichas técnicas */}
            <Text className={getContentStyle()}>Contenido de las fichas técnicas...</Text>
          </ScrollView>
        </View>
      </View>
    </View>
